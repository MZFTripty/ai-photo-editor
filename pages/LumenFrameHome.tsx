      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground mb-8 text-pretty max-w-2xl mx-auto">
            Transform your images by simply describing what you want. LumenFrame
            uses advanced AI to understand your creative vision and deliver
            professional-quality edits in seconds.
          </p>
            ...
            <div className="bg-muted rounded-lg p-6 mb-4">
              ...
              <div className="bg-background rounded-lg p-4 border border-border">
                ...
                <p className="text-foreground font-medium">
                  "Remove the lamp and make the sky more dramatic"
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Professional-grade editing capabilities powered by cutting-edge AI
              technology
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-border">
              <CardHeader>
                ...
                <CardDescription>
                  Describe your edits in plain English. No complex tools or
            ...
            <Card className="border-border">
              <CardHeader>
                ...
                <CardDescription>
                  Get instant previews and professional-quality results in under
                  90 seconds.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-border">
              <CardHeader>
                ...
                <CardDescription>
                  Apply consistent edits across multiple images with saved
                  command macros.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-border">
              <CardHeader>
                ...
                <CardDescription>
                  Every edit includes metadata for transparency and professional
                  workflows.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-border">
              <CardHeader>
                ...
                <CardDescription>
                  Built-in ethical guardrails and consent flows for responsible
                  AI editing.
                </CardDescription>
              </CardHeader>
            </Card>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join thousands of creators, photographers, and businesses using
            LumenFrame to streamline their editing workflow.
          </p>
          <Button size="lg" className="text-lg px-8" asChild>
      ...
      <footer className="border-t border-border bg-card/50 py-12 px-4">
        <div className="container mx-auto">
          ...
          <div className="pt-8 border-t border-border text-center text-sm text-muted-foreground">
            <p>
              © 2025 LumenFrame. Built with advanced AI technology for creative
              professionals.
            </p>
            <p className="mt-2">
